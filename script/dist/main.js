...
import { DrawTile, BG_tile_imgs, Dialog_tile_imgs, clearScreen, drawTexts, applyRenderState, addText, removeText, replaceText } from "./render.js";
console.clear();
let debug_mode = {
    enabled: true,
};
...
console.log("debug_mode exposed", debug_mode);
const gameSetting = {
    boostmode: false,
};
...
let text_score_uuid = addText('Score : N/A', 4, -10, 0.65);
let select = "start";
...
function gameLoop(time) {
    ...
    replaceText(text_score_uuid, `Score : ${player.height}`, 3.85, dialogScoreYpos + 0.75, 0.5);
    drawTexts();
}
requestAnimationFrame(gameLoop);
resizeCanvas();
